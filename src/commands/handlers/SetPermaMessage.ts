...
export default class SetPermaMessage implements CommandHandler {
    data = new SlashCommandBuilder()
        ...
        .addBooleanOption((option) =>
            option.setName("enabled").setDescription("Turn permamessage on or off").setRequired(false),
    ...
    private async enablePermaMessage(interaction: ChatInputCommandInteraction): Promise<void> {
    ...
    private async disablePermaMessage(interaction: ChatInputCommandInteraction): Promise<void> {
