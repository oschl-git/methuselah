...
const helpCommands = resourceLoader.loadYaml<HelpCommandEntry[]>("helpCommands");
        ...
        for (const command of helpCommands) {
            if (
                ...
                !memberPermissions.has(
                    PermissionFlagsBits[command.requiredPermission as keyof typeof PermissionFlagsBits],
                )
            ) {
                continue;
            }
