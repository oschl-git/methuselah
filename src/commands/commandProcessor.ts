...
export const commands: Collection<string, CommandHandler> = new Collection<string, CommandHandler>();
...
async function processCommand(interaction: Interaction): Promise<void> {
    ...
    try {
        ...
        await cooldownManager.setCooldown(interaction.commandName, interaction.user.id);
